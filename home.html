...
<body class="bg-white dark:bg-slate-200">
  <nav class="bg-gradient-to-r from-sky-300 to-blue-300 dark:bg-gradient-to-r from-sky-800 to-blue-800">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <a href="home.html" class="self-center text-xl font-semibold whitespace-nowrap text-gray-400 hover:text-gray-400 md:hover:bg-transparent dark:text-sky-500 dark:hover:text-sky-500" aria-current="page">Bibliothèque Numérique Unifiée</a>
